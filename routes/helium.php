...
Route::middleware(RedirectIfAuthenticated::using(config('helium-core.auth.guard-name')))->group(function () {
...
Route::middleware(Authenticate::using(config('helium-core.auth.guard-name')))->group(function () {
